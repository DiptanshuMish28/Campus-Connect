...
class MyDetails:
    def __init__(self, myResults):
        ...
        def toUpdatePage():
            # popup.askyesno("CampusConnect", "Want to update your info : ")
            if popup.askyesno("CampusConnect", "Want to update your info?"):
                getPass()
            else:
                pass
        ...
        myWall = ImageTk.PhotoImage(Image.open("images/myDetails.jpg"))
        ...
        showID = Label(newWindow, text=myResults[0], font=(
            "Product Sans", 14, "bold"))
        ...
        showName = Label(newWindow, text=myResults[1], font=(
            "Product Sans", 14, "bold"))
        ...
        showPass = Label(newWindow, text=myResults[2], font=(
            "Product Sans", 14, "bold"))
        ...
        showGen = Label(newWindow, text=myResults[3], font=(
            "Product Sans", 14, "bold"))
